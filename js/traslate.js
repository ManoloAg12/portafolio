        const translations = {
            es: {
                ...
                hero_desc: "Estudiante de 5.º año de Licenciatura en Informática, enfocado en el desarrollo de software. Cuento con experiencia práctica en la creación de aplicaciones full-stack utilizando <strong class='text-brand-accent'>Java (Spring Boot, JPA)</strong> y <strong class='text-brand-accent'>.NET (C#, ASP.NET)</strong>. Sólidos conocimientos en la gestión de bases de datos SQL (<strong class='text-brand-accent'>SQL Server, MySQL, PostgreSQL</strong>). Motivado por integrarme a un equipo de desarrollo donde pueda aplicar mis habilidades técnicas, seguir aprendiendo nuevas tecnologías y colaborar en proyectos desafiantes.",
            ...
            en: {
                ...
                hero_desc: "5th-year Computer Science student focused on software development. I have practical experience building full-stack applications using <strong class='text-brand-accent'>Java (Spring Boot, JPA)</strong> and <strong class='text-brand-accent'>.NET (C#, ASP.NET)</strong>. Solid knowledge in SQL database management (<strong class='text-brand-accent'>SQL Server, MySQL, PostgreSQL</strong>). Motivated to join a development team where I can apply my technical skills, keep learning new technologies, and collaborate on challenging projects.",
